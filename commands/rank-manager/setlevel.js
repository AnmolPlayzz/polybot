...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('set-level')
        .setDescription('Set the level for a user on this server.')
